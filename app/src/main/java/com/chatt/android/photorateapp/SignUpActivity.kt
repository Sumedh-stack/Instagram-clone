...
class SignUpActivity : AppCompatActivity() {
        ...
        private fun CreateAccount() {
         ...
         private fun saveUserInfo(fullName: String, userName: String, email: String, progressDialog: ProgressDialog) {
            ...
            userMap["email"]=email
            userMap["bio"]="hey this is my first App"
            userMap["image"]="https://firebasestorage.googleapis.com/v0/b/instagram-clone-5552c.appspot.com/o/Default%20Images%2Fprofile.png?alt=media&token=ff857d5f-27db-487b-8885-f32c03899c23"
